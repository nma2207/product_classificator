...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Отправитель почты"))
        self.receiverLabel.setText(_translate("Form", "Получатель:"))
        self.subjectLabel.setText(_translate("Form", "Тема:"))
        self.messageLabel.setText(_translate("Form", "Сообщение:"))
        self.senderLabel.setText(_translate("Form", "Отправитель:"))
        ...
        self.dateAndTimeLabel.setText(_translate("Form", "Дата: " + currentDate))
